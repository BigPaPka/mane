...
public class Payment
{
    ...
    public boolean equals(Object o) {
        ...
        return year == payment.year && month == payment.month && day == payment.day && Double.compare(payment.sum, sum) == 0 && Objects.equals(name, payment.name);
    }
    ...
    public static void main(String[] args) {
        Payment payment=new Payment("dw",2002,12,2,31);
        payment.toString();
        System.out.println( payment.toString());
        Payment payment1=new Payment("dw",2002,12,2,31);
        boolean q=payment.equals(payment1);
        System.out.println(q);
        System.out.println(payment.hashCode());
        System.out.print(payment1.hashCode());
